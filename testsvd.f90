...
!
	...
	open(15,file='/public/home/cuicr/code/get-tau-for-Kang/ssta.nov1981-may2014.kl.dta',  &
       form='unformatted',access='direct',convert='big_endian',recl=imt*jmt*1 )
...
! read in monthly svd statistics
	...
	open(97,file='/public/home/cuicr/code/get-tau-for-Kang/fort.97-month',form='unformatted',convert='big_endian')
...
10      sst(i,j)=odata(i,j)
        ! write(*,*) sst
         open(14, file='/public/home/cuicr/code/ccr/sst.dat', form='unformatted',  & 
             access='direct', recl=irec_len1)
         write(14,rec=1) sst
